      ...
      <div class="container admin">
        <div class="row">
          <div class="col-md-6">
            ...
            <form>
              <div>
                <label style="font-weight:bold ; ">Nom:</label><?php echo '  '.$item['name'];?>
              </div>
              <br>
              <div>
                <label style="font-weight:bold ; ">Description:</label><?php echo '  '.$item['description'];?>
              </div>
              <br>
              <div>
                <label style="font-weight:bold ; ">Prix:</label><?php echo '  '.number_format((float)$item['price'], 2, '.', ''). ' €';?>
              </div>
              <br>
              <div>
                <label style="font-weight:bold ; ">Catégorie:</label><?php echo '  '.$item['category'];?>
              </div>
              <br>
              <div>
                <label style="font-weight:bold ; ">Image:</label><?php echo '  '.$item['image'];?>
              </div>
            </form>
            <br>
